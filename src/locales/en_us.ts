 ...
 * Same as en.ts but with US flag for Windows compatibility
 */
export const en_us = {
  // App
  ...
  speedTrainerTooltip: 'Increase speed automatically each time the loop restarts',
  increment: 'Increment',
  startSpeed: 'Start Speed',
  endSpeed: 'End Speed',
  strategy: 'Strategy',
  strategyMelody: 'Melody Only (Highest)',
  strategyBass: 'Bass Only (Lowest)',
  strategyBassMelody: 'Duo (Bass + Melody)',
  strategyAll: 'Full Chords (Original)',
} as const;