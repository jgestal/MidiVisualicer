import { Language } from '@/shared/context/I18nContext';
...
export const MANUALS: Record<Language, Manual> = {
    en: {
        title: 'User Manual',
        sections: [
            {
    ...
    pt: {
        ...
        sections: [
            ...
            },
            {
                ...
                content: 'Use los controlos de Loop A-B para definir pontos de início e fim para praticar secções específicas repetidamente.',
            },
            {
        ...
        sections: [
            {
                ...
                content: 'Trascina e rilascia un file MIDI nell\'applicazione o clicca per aprire il browser dei file. Una vez caricato, vedrai la tablatura e la notazione della tua musica.',
            },
            {
            ...
            },
            {
                ...
                content: 'Usa i pulsanti play, pausa e stop per controllare la riproduzione. Regola la velocità usando el menu a discesa. Attiva il metronomo per aiutarti con el ritmo.',
            },
            {
    ...
    ko: {
        ...
        sections: [
            {
                heading: '1. 시작하기',
                content: 'MIDI 파일을 애플리케이션에 드래그 앤 드롭하거나 ক্লিক하여 파일 브라우저를 엽니다. 로드되면 음악의 타브악보와 악보를 볼 수 있습니다.',
            },
            {
                heading: '2. 악기 선택',
